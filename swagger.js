...
app.use(cors({
  origin: (origin, callback) => {
    // Permite peticiones sin origen (Postman/Swagger), localhost o dominios permitidos
    if (!origin || origin.startsWith('http://localhost:') || origin.endsWith('.onrender.com') || allowedDomains.includes(origin)) {
